...
/*   Updated: 2022/11/02 16:32:32 by bvarlamo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class map_iterator
	{
		...
		public:
			...
			// map_iterator (const map_const_iterator& rev_it) : current_node(rev_it.current_node), root(rev_it.root)
			// {}
	...
	template<class node, class _value_type, class _roo>
	bool operator==( const ft::map_iterator<node, _value_type, _roo>& lhs,
                 const ft::map_iterator<node, _value_type, _roo>& rhs )   
	{
