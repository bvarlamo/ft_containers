...
void test_vector()
{
    ...
    /* Range constructor */
    {
		int range_array1[] = { 45, 87846, 12, 965, 5 };
    ...
    /* Copy constructor */
    {
        int range_array1[] = { -89, 561, 874, 7777 , 987, -6 };
        
        std::vector<int> range_array(&range_array1[0], &range_array1[6]);
		ft::vector<int> range_arrayf(&range_array1[0], &range_array1[6]);
    ...
    /* Assign operator */
    {
        ...
        fs.open("./tester/vectors_output/assign_operator", std::fstream::in | std::fstream::out | std::fstream::trunc);
    ...
    /* Iterator begin() */
    {
        int range_array1[] = { 87, 92, -5, 8984, 96 };
    ...
    /* Iterator end() */
    {
        int range_array1[] = { 48, 967, 52, -45, -9, 956551, 44};
    ...
    /* Const iterator end() */
    {
        int range_array1[] = { 95, 89, -6121, 48, 5 };
    ...
    /* Iterator rbegin() */
    {
        int range_array1[] = {250, -1200, -98657, 2, 34};
    ...
    {
        int range_array1[] = { 958, -561, 54, 789, -8};
        ...
        /* Iterator rend() */
    {
        int range_array1[] = {78, -951, 562, 8, 745, 51236, 6987};
    ...
    /* Const iterator rend() */
    {
        int range_array1[] = { 8, -5615, 412, 89, 475};
    ...
    /* Operator [] */
    {
        ...
        std::vector<int>::iterator stl_iterator_beg(range_array.begin());
        ft::vector<int>::iterator ft_iterator_beg(range_arrayf.begin());
    ...
    /* Const Operator [] */
    {
        int range_array1[] = {8, -98, 541, 53361, 9};
    ...
    /* Const at() */
    {
        int range_array1[] = {845, -9, 47, 4, -825};
    ...
    /* Const front() */
    {
        int range_array1[] = {5589, -97, -98, -63, 8};
    ...
    /* Assign range */
    {
        int range_array1[] = {84, 522, -654, -7623, 4};
    ...
    {
        int range_array1[] = {547, 98, -6, 0, 47};
    ...
    {
        int range_array1[] = {478, 87, -85, 44, 7};
    ...
    /* Insert fill */
    {
        int range_array1[] = {47, 152, -325, 9, 14444};
    ...
    /* Erase range */
    {
        int range_array1[] = {1458, -98, 745, 62, 9};
    ...
    /* Swap */
    {
		...
		std::vector<int> range_array(&range_array_one[0], &range_array_one[5]);
		ft::vector<int> range_arrayf(&range_array_one[0], &range_array_one[5]);
		std::vector<int> range_array1(&range_array_two[0], &range_array_two[5]);
		ft::vector<int> range_arrayf1(&range_array_two[0], &range_array_two[5]);

        std::vector<int>::iterator stl_iterator_beg_one(range_array.begin());
        std::vector<int>::iterator stl_iterator_beg_two(range_array1.begin());
        ft::vector<int>::iterator ft_iterator_beg_one(range_arrayf.begin());
        ft::vector<int>::iterator ft_iterator_beg_two(range_arrayf1.begin());
    ...
    /* Clear */
    {
        int range_array1[] = {-455, 2, 1347, 75, 945};
